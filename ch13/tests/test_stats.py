...
class TestCountNone:
    ...
    def test_count_none_with_none(self):
        """Test count_none with some None values."""
        data = StatsList([1, None, 3, None, 5])
        assert data.count_none() == 2

    def test_count_none_all_none(self):
    ...
    def test_count_none_single_none(self):
